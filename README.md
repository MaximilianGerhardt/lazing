...
> The images in this README are rendered from laz.ing's own design system —
> on-brand HTML templates drawn straight to PNG with
> [`scripts/render-repo-images.mjs`](scripts/render-repo-images.mjs)
> (`node scripts/render-repo-images.mjs`). Same pitch-black canvas, glows and
> typography as the app itself.
